            ...
            success: function(resp) {
              ...
              $(tabla).dataTable( {
                ...
                "fnRowCallback":function( nRow, aData, iDisplayIndex, iDisplayIndexFull ){
                          ...
                          if(tabla==="#tablaMaterialesConsultaDesincorporacion"){
                              //console.log(action)
                             if(action ==='llenarTableConsultaMaterialesDesincorporados'){
                                 var boton = $(nRow).find(".botonRow");
                                 var btnEmpleado = $(nRow).find(".botonRow");
                                 $(btnEmpleado).removeClass("btn-primary").html("<span class='icon-ok'>Incorporar</span>");
                                 $(btnEmpleado).addClass(" btn-warning ");
                                 $(btnEmpleado).off();// Se elimina el Evento anterior 
                                 $(btnEmpleado).on("click",function () {
                                    $(nRow).removeClass("selected");                                   
                                   selectTipoMaterialDesincorporar(aData);
                                 }); 
                             }
                             if(action ==='llenarTableConsultaMaterialesDisponibles'){
                                 var boton = $(nRow).find(".botonRow");
                                 var btnEmpleado = $(nRow).find(".botonRow");
                                 $(btnEmpleado).removeClass("btn-primary").html("<span class='icon-ok'>Desincorporar</span>");
                                 $(btnEmpleado).addClass(" btn-danger ");
                                 $(btnEmpleado).off();// Se elimina el Evento anterior 
                                 $(btnEmpleado).on("click",function () {
                                    $(nRow).removeClass("selected");
                          ...
                          if(tabla==="#tablaTipoMateriales"){
                             var boton = $(nRow).find(".botonRow");
                                 var btnEmpleado = $(nRow).find(".botonRow");
                                 $(btnEmpleado).removeClass("btn-primary").html("<span class='icon-ok'>Editar</span>");
                                 $(btnEmpleado).addClass(" btn-info");
                                 $(btnEmpleado).off();// Se elimina el Evento anterior 
                                 $(btnEmpleado).on("click",function () {
                                    $(nRow).removeClass("selected");
                                    selectTipoMaterialEditar(aData);
                                 }); 
                                 $(btnEmpleado).parent().attr('style','text-align:center');
                          }    
